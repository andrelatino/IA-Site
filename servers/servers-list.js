...
function serversList() {
  fetch("servers.json")
      ...
      .then(data => {
          ...
          addSubtitle.className = 'servers-grid';
          addSubtitle.innerHTML = `
              <div class='servers-subtitle'>
              <p>Total: ${showTotal}</p>
              <button id="addNewSite" onclick="modalOpen();" class="servers-add">
