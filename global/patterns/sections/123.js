  ...
  function _123() { 
    ...
    @media screen and (min-width:0px){#${item1_css}{object-fit:cover;height:100%;min-height:50vh;width:100%}}
    @media screen and (min-width:0px){#${item2_css}{object-fit:cover;height:100%;min-height:50vh;width:100%}}
    @media screen and (min-width:0px){#${item3_css}{object-fit:cover;height:100%;min-height:50vh;width:100%}}
    @media screen and (min-width:0px){#${item4_css}{object-fit:cover;height:100%;min-height:50vh;width:100%}}
